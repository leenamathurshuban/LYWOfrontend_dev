...
import liwotextlogo from '../../images/liwo_textlogo.png';
import cprofilelogo from '../../images/cp_logo.png';
import starIcon from '../../images//icons/star-05.svg';
import { Col, Container, Row, Breadcrumb, Card, Button, Modal, Form, Accordion, Tab, Nav } from 'react-bootstrap';
        ...
        <>
            ...
            <div className='page-body'>
                <Container fluid>
                    ...
                    <Row>
                        <Col md={12}>
                            <h1 className='h1_welcometext'>Get started on your journey to <strong>build the dream team</strong></h1>
                        </Col>
                    </Row>
                    <Row>
                        <Col md={4}>
                        ...
                        <Col md={4}>
                            <Card className='mdt_card'>
                                <Card.Body>
                                    <span className='mdt_name'>
                                        pe
                                    </span>
                                    <Card.Title>Complete Company Profile</Card.Title>
                                    <Button variant="primary" onClick={handleShow}>Start</Button>
                                </Card.Body>
                            </Card>
                        </Col>
                        <Col md={4} className='com_infotext'>
                            <img src={liwotextlogo} alt='' />
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam a orci nisl. Pellentesque a sem in lacus sodales tincidunt. Cras velit turpis, lobortis id dapibus id, feugiat eu arcu. Fusce nisl odio, varius vel nunc et, tristique dignissim justo. Sed blandit risus dolor, nec iaculis mi ultrices sed. Cras feugiat dui quis scelerisque consequat. Phasellus tempus sodales dolor, sit amet tristique velit volutpat non. Fusce efficitur pharetra ex quis mattis. Duis pellentesque ipsum id purus fringilla semper.</p>
                        </Col>
                    </Row>
                </Container>
            ...
            <Modal show={show} onHide={handleClose} animation={false} size="lg" className='cmprofile_mdl'>
                    ...
                    <Row>
                        <aside className='model_sidebar col-md-2'>
                            ...
                            <Nav variant="pills" className="flex-column mdl_sdbarmenu">
                                <Nav.Item>
                                    <Nav.Link eventKey="first">Profile<span>80% Complete</span></Nav.Link>
                                </Nav.Item>
                                <Nav.Item>
                                    <Nav.Link eventKey="second">Users<span>4 Active,3 Pending</span></Nav.Link>
                                </Nav.Item>
                            </Nav>
                        </aside>
                                            ...
                                            <Col md={9}>
                                                <div className='mdl_pagetitle d-flex justify-content-between align-items-center'>
                                                    ...
                                                    <div className='btn_group'>
                                                        <Button variant="link" className='me-2'>Cancel</Button>
                                                            ...
                                                            <Row>
                                                                <Col md={6}>
                                                                    ...
                                                                    <Form.Group className="mb-3">
                                                                        ...
                                                                        <span className='words_limit'>250/500 Words</span>
                                                                    </Form.Group>
                                                                </Col>
                                                                <Col md={6}>
                                                                    <Form.Group className="mb-3">
                                                                    ...
                                                                    <Form.Group className="mb-3">
                                                                        ...
                                                                        <Form.Control type="text" placeholder="Headquarter" />
                                                                    </Form.Group>
                                                                    <Form.Group className="mb-3">
                                            ...
                                            <Col md={3} className='cmp_details'>
                                                ...
                                                <div className='rects-panel'>
                                                    ...
                                                    <ul className='rects_list'>
                                                        <li><img src={starIcon} />Add Logo</li>
                                                        <li><img src={starIcon} />Add Website</li>
                                                        <li><img src={starIcon} />Add Detailed Discription</li>
                                                        <li><img src={starIcon} />Select Company Size</li>
                                                    </ul>
                                                </div>
                                            </Col>
                                        </Row>
