...
const Dashboard = () => {
  ...
  const JobListApi = async () => {
    ...
    let url = `https://bittrend.shubansoftware.com/assets-api/job-list-by-company-api/${companyInfo?.uid}/?page=1&limit=2000&search=${""}`
    try {
          ...
          {!JobData?.length ? (
            <>
              <Row className="mt-3">
                ...
                <Col md={4} className="">
                  <div className="light-shadows com_infotext">
                    <img src={liwotextlogo} alt="" />
                    <p>
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam
                      a orci nisl. Pellentesque a sem in lacus sodales tincidunt. Cras
                ...
                <Card className="border-0 hiring_pipeline mt-4">
                  ...
                  <Card.Body className="p-0 mt-3">
                    <div className="hiring_ppldata table-responsive">
                      {tableShow ? (
                        <table className="m-0 table table-striped elv_datatable table-bordered dashboard-table">
                          <thead>
                            <tr>
                              <th>Job</th>
                              <th>Location</th>
