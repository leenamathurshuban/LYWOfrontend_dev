    ...
    const getJobDetails = async () => {
        ...
        try {
            ...
            setUpdateFormData({
                ...
                // //job_company: response?.data?.response?.job_company?.uid,
                                                ...
                                                {["checkbox"].map((type) => (
                                                    <div key={`inline-${type}`} className="me-3">
                                                        <Form.Check
                                                            ...
                                                            type={type}
                                                            id={`inline-${type}-1`}
                                                            checked={updateFormData?.higher_qualification_preferred ? true : false}
                                                        />
                                                        <Form.Check
                                                            inline
                                                            ...
                                                            type={type}
                                                            id={`inline-${type}-2`}
                                                            checked={updateFormData?.other_areas_acceptable ? true : false}
                                                        />
                                                    </div>
                                                ))}
                                            </Form>
                                        ...
                                        <Row className="align-items-center">
                                            ...
                                            >
                                                <Form.Control
                                                    ...
                                                    defaultValue={updateFormData?.targate_hire_date}
                                                />
                                            </Form.Group>
                                        </Row>
                                        <div className="accordion_footer">
                                                ...
                                                {["checkbox"].map((type) => (
                                                    <div key={`inline-${type}`} className="me-3">
                                                        <Form.Check
                                                            ...
                                                            type={type}
                                                            checked={updateFormData?.immediate_hiring ? true : false}
                                                            id={`inline-${type}-1`}
                                                        />
                                                        <Form.Check
                                                            inline
                                                            ...
                                                            type={type}
                                                            id={`inline-${type}-2`}
                                                            checked={updateFormData?.explore_buy_out_option ? true : false}
                                                        />
                                                    </div>
                                                ))}
                                            </Form>
                                                ...
                                                {["checkbox"].map((type) => (
                                                    <div key={`inline-${type}`} className="me-3">
                                                        <Form.Check
                                                            ...
                                                            id={`inline-${type}-1`}
                                                            checked={createRevisedJobData?.no_specific_language_require ? true : false}
                                                        />
                                                    </div>
                                                ))}
                                            </Form>
                                                ...
                                                {["checkbox"].map((type) => (
                                                    <div key={`inline-${type}`} className="me-3">
                                                        <Form.Check
                                                            ...
                                                            type={type}
                                                            id={`inline-${type}-1`}
                                                            checked={createRevisedJobData?.no_specific_location ? true : false}
                                                        />
                                                        <Form.Check
                                                            inline
                                                            ...
                                                            onChange={handleFormData}
                                                            id={`inline-${type}-2`}
                                                            checked={createRevisedJobData?.relocation_cost_covered ? true : false}
                                                        />
                                                    </div>
                                                ))}
                                            </Form>
                                    ...
                                    <Accordion.Body>
                                        ...
                                        <div class="d-flex justify-content-center align-items-center col-md-12 mt-3">
                                            <button
                                                onClick={handleCreateForm}
                                                type="button"
                                                disabled={!createRevisedJobData?.calculation_job.length}
