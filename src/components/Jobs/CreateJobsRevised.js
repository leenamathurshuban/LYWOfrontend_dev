            ...
            <Col md={7} lg={8} className="jobMain_panel">
              ...
              >
                <Accordion.Item eventKey="0">
                  ...
                  <Accordion.Body>
                    <p>
                      Use this section to define your ideal hire in more
                      detail. All the information required in this section
                      is mandatory. The information from this section will
                      play an essential role in scoring and screening
                      candidates based on their profile.
                    </p>
                    <p>
                      If there is any one parameter that is very important
                      [Yellow Flag] or a must have [Red Flag], use the flags
                      to indicate the same. This information will allow us
                      to rate each application as below.
                    </p>
                    ...
                    <Form>
                      <Form.Group className="mb-3">
                        ...
                        <span className="required_text">
                          Select the minimum level of education that you
                          would require
                        </span>
                      </Form.Group>
                      <Form.Group
                  ...
                  <Accordion.Body>
                    <Form>
                      ...
                      >
                        ...
                        />
                        <span className="required_text">
                          Please add multiple versions of the role and
                          multiple roles that can ensure you do not exclude
                          any deserving applicants
                        </span>
                      </Form.Group>
                    </Form>
                    <div className="accordion_footer">
                ...
                <Accordion.Item eventKey="7">
                  ...
                  <Accordion.Body>
                    <p>
                      In this section, you can add additional optional
                      details such as Skills expected from the ideal
                      candidate and also add some specific questions that
                      will allow you to gain a deeper insight about the
                      candidate.
                      <br />
                      <br />
                      Don’t forget that here too Skills or Questions can be
                      marked as very important [Yellow Flag] or a must have
                      [Red Flag] to indicate the Importance to you.
                    </p>
                  </Accordion.Body>
                </Accordion.Item>
                  ...
                  <Accordion.Body>
                    <Row className="skills_seraching">
                      ...
                      <Col md={3}>
                        ...
                        >
                          <i className="fa fa-plus me-2"></i>Create Skill
                          Group
                        </button>{" "}
                      </Col>
                    </Row>
              ...
              <div className="ct_scrollbar pb-3">
                ...
                <div className="user_bsinfo">
                  ...
                  <ul>
                    ...
                    <li>
                      Should be from Mumbai, Hyderabad, Delhi, Bangalore
                    </li>
                  </ul>
                </div>
                <div className="user_bsinfo">
                ...
                <div className="user_bsinfo">
                  ...
                  <ul>
                    <li>
                      Collecting plant data and providing design feedback to
                      team
                    </li>
                    <li>
                      Performing material balance, energy balance for the
                      plant along with utility calculations.
                    </li>
                    <li>
